package com.prototype.myapplication;
...
public class MainActivity extends Activity {
    ...
    EditText editFname, editMname, EditLname, EditAddress, EditCity,EditSexM, EditSexF, EditBirth, EditMobile, EditEmail, EditPassword;

    String GetFName, GetMName, GetLName, GetAddress, GetCity, GetSex, GetBirth, GetMobile, GetEmail, GetPassword;

    Button Confirm, Back;

    String DataParseUrl = "http://carkila.000webhostapp.com/insert_data.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditSexM = (EditText)findViewById(R.id.btnMale);
        EditSexF = (EditText)findViewById(R.id.btnFemale);
