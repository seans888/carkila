...
public class RenterRegistration extends Activity {
        ...
        BtnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(Email,Pass)
                        .addOnCompleteListener(RenterRegistration.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(!task.isSuccessful()){
                                    Toast.makeText(RenterRegistration.this, "Authentication failed, email is already in use.", Toast.LENGTH_SHORT).show();
                                }
                                else{
                                    GetData();
                                    InsertUser(getFName, getMName, getLName, getAddress, getCity, getGender, getBirthdate, getMobile, getEmail, getPassword);
                                    startActivity(new Intent(RenterRegistration.this, RenterHome.class));
                                }
                            }
                        });
            }
    ...
    public void InsertUser(final String firstName, final String midName, final String lastName, final String address, final String city, final String sex, final String birthDate, final String mobileNumber, final String email, final String password){
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                Toast.makeText(RenterRegistration
                        .this, "Registration Successful!", Toast.LENGTH_LONG).show();
